...
import com.slxy.www.domain.po.ExcelBean;
...
//                PropertyDescriptor pd = new PropertyDescriptor(em.getPropertyName(), clazz);
                PropertyDescriptor pd = getPropertyDescriptor(clazz,em.getPropertyName());
                ...
                if (rtn != null) {
                    if (rtn instanceof Date) {
                        value  = (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(rtn).toString();
