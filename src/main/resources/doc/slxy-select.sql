...
INSERT INTO `select_major` VALUES ('6', '数学', '26', '3', '1', '事故学', '2018-01-22 16:58:24', '2018-01-24 17:24:55');
INSERT INTO `select_major` VALUES ('7', '111', '7', '1', '1', '121212', '2018-01-25 17:23:34', null);
...
-- ----------------------------
-- Table structure for select_role
-- ----------------------------
DROP TABLE IF EXISTS `select_role`;
CREATE TABLE `select_role` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '角色id',
  `role_name` varchar(20) DEFAULT NULL COMMENT '角色名',
  `role_number` varchar(10) DEFAULT NULL COMMENT '角色编号',
  `permissions` text COMMENT '权限id集合',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of select_role
-- ----------------------------
INSERT INTO `select_role` VALUES ('1', '管理员', 'admin', null);
INSERT INTO `select_role` VALUES ('2', '教师', 'teacher', null);
INSERT INTO `select_role` VALUES ('3', '学生', 'student', null);
...
-- ----------------------------
INSERT INTO `select_subject` VALUES ('1', '选题系统', '12', '2', '选题选题', '1', '2', '恭喜您，论文审核通过！！！', '1', '0', '0', '0', '0', '7', '2014', '2018-01-25 16:57:28', '2018-02-05 16:12:03');
INSERT INTO `select_subject` VALUES ('2', '房产系统', '12', '2', '房产', '0', '1', '测试不过', '1', '0', '0', '0', '0', '7', '2014', '2018-01-25 17:07:05', '2018-02-01 16:14:11');
INSERT INTO `select_subject` VALUES ('3', '影视介绍', '12', '1', 'ing是影视', '0', '2', '恭喜您，论文审核通过！！！', '1', '0', '0', '0', '0', '7', '2014', '2018-01-25 17:08:16', '2018-02-05 11:07:23');
INSERT INTO `select_subject` VALUES ('4', '旅游展示', '12', '1', '旅游啊啊啊啊', '0', '0', null, null, '0', '0', '0', '0', '7', '2013', '2018-01-24 17:09:47', '2018-02-01 16:14:12');
INSERT INTO `select_subject` VALUES ('5', '新闻介绍', '12', '1', '新闻上新闻', '1', '2', 'u哦股顾工', '1', '0', '0', '0', '0', '7', '2013', '2018-01-17 17:10:31', '2018-02-05 16:10:19');
INSERT INTO `select_subject` VALUES ('6', '网络搭建', '12', '2', '网络网络啊', '0', '0', null, null, '0', '0', '0', '0', '7', '2013', '2018-01-10 17:11:09', '2018-02-01 16:14:12');
INSERT INTO `select_subject` VALUES ('7', '校园网组件', '12', '2', '鞍组件', '0', '0', null, null, '0', '0', '0', '0', '7', '2013', '2018-01-06 17:11:56', '2018-02-01 16:14:12');
INSERT INTO `select_subject` VALUES ('8', '网络维护', '12', '1', '鞥', '0', '0', null, null, '0', '0', '0', '0', '7', '2013', '2018-01-13 17:12:33', '2018-02-01 16:14:12');
INSERT INTO `select_subject` VALUES ('9', '撒谎的骄傲开始', '12', '2', '是哪家快递哈是', '0', '0', null, null, '0', '0', '0', '0', '27', '2015', '2018-02-02 09:55:38', '2018-02-02 09:57:48');
INSERT INTO `select_subject` VALUES ('10', '倒萨倒萨', '12', '2', '萨达阿三', '0', '0', null, null, '0', '0', '0', '0', '7', '2016', '2018-02-02 09:58:13', '2018-02-02 10:09:56');
INSERT INTO `select_subject` VALUES ('11', '撒大苏打', '12', '1', ' 啊实打实大神', '0', '0', null, null, '0', '0', '0', '0', '27', '2017', '2018-02-02 10:01:39', null);
INSERT INTO `select_subject` VALUES ('12', '231216', '2', '1', '31654156', '0', '0', null, null, '0', '0', '0', '0', '8', '2016', '2018-02-02 10:57:25', null);
INSERT INTO `select_subject` VALUES ('13', '实打实的撒', '2', '2', '撒打算', '0', '1', 'teacher不过', '1', '0', '0', '0', '0', '7', '2016', '2018-02-02 10:58:12', '2018-02-02 14:36:01');
INSERT INTO `select_subject` VALUES ('14', '撒旦撒旦阿三', '2', '2', '撒打算', '0', '2', '恭喜您，论文审核通过！！！', '1', '0', '0', '0', '0', '26', '2016', '2018-02-02 10:59:28', '2018-02-02 14:35:48');
...
-- ----------------------------
INSERT INTO `select_topic` VALUES ('5', '5', '12', '4', '232432', '0', null, '2013', '2018-02-05 16:10:18', null);
INSERT INTO `select_topic` VALUES ('6', '1', '12', '3', '撒打算', '0', null, '2014', '2018-02-05 16:12:03', null);
...
-- ----------------------------
INSERT INTO `select_user_base` VALUES ('1', 'admin', '123456', 'admin', '1', '489671435@qq.com', '13108018752', '489671435', null, null, null, null, null, null, null, null, null, '1', '1', null, '2018-01-02 17:19:59', '2018-01-28 19:28:42');
INSERT INTO `select_user_base` VALUES ('2', 'teacher1', '123456', 'teacher', '1', 'zhengql@senthink.com', '13108018752', '489671435', null, null, null, '1', '网络工程', '1', '网络搭建网络搭建网络搭建', '7', '暂无', '1', '2', null, '2018-01-02 17:32:28', '2018-02-02 11:25:17');
INSERT INTO `select_user_base` VALUES ('3', 'student', '123456', 'student', '1', 'zhenql@lierda.com', '13108018752', '1223656', '1', '1', '2014', null, null, null, null, null, null, '1', '3', null, '2018-01-02 17:39:32', '2018-02-02 11:24:19');
...
INSERT INTO `select_user_base` VALUES ('6', 'c002', '123456', '陈昊天', '1', 'zhenql@lierda.com', '13108018752', '65165161', '1', '2', '2014', null, null, null, '', null, '', '1', '3', null, '2018-01-05 09:56:02', '2018-02-02 11:24:22');
INSERT INTO `select_user_base` VALUES ('7', 'f002', '123456', '付荣刚', '1', 'zhenql@lierda.com', '13108018752', '51616545', '6', '2', '2016', null, null, null, '', null, '', '1', '3', null, '2018-01-06 09:56:02', '2018-02-02 11:24:40');
INSERT INTO `select_user_base` VALUES ('8', 'chunmei', '123456', '黄春梅', '1', 'chunmei@lierda.com', '111123213123', '156123023', '1', '2', '2014', null, null, null, '', null, '', '1', '3', null, '2018-01-07 09:58:22', '2018-02-02 11:24:25');
