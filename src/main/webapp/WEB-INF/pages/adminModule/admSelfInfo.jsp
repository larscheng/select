                    ...
                    <div class="widget wgreen">
                        ...
                        <div class="widget-head"  style="position: relative">
                            ...
                            <div class="row navbar-form " style="position: absolute; top: -5px; right: 50px">
                                ...
                                <button type="button"  onclick="window.location.href='${ctx}/initChangeAdmPs?id=${sessionScope.sessionUser.id}';" style="margin-right: 10px" class="btn btn-info pull-left "><i class="icon-upload"></i>密码修改</button>
                            </div>
                            <div class="clearfix"></div>
                        </div>
