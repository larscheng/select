...
<div class="sidebar">
    ...
    <ul id="nav" style="display: block;">
        ...
        <li><a href="/selectUserBase/userList"  target="mainFrame" class=""><i class="icon-home"></i> 首页</a>
            <!-- Sub menu markup
            <ul>
        ...
        <li class="has_sub"><a href="#" ><i class="icon-list-alt"></i> 学生信息管理  <span class="pull-right"><i class=""></i></span></a>
            <%--<ul>--%>
        ...
        <li class="has_sub"><a href="#"><i class="icon-file-alt"></i> 教师信息管理 <span class="pull-right"><i class=""></i></span></a>
            <%--<ul>--%>
