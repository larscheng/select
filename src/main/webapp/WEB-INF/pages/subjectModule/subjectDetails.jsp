...
<div class="mainbar">
    ...
    <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
            <a href="${ctx}/index" target="_top"><i class="icon-home"></i> 论文信息管理</a>
            <!-- Divider -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-2">
                                            <a class="btn btn-info"
                                               href="http://127.0.0.1:8012/onlinePreview?url=http://127.0.0.1:8012/${requestScope.sub.subFile}" target="_blank">预览</a>
                                            <a class="btn btn-info"
