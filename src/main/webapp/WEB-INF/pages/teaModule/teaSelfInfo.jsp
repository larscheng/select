...
<div class="mainbar">
    ...
    <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
            <a href="${ctx}/index" target="_top"><i class="icon-home"></i> 个人信息</a>
            <!-- Divider -->
                                ...
                                <form class="form-horizontal" role="form" id="updateForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <input type="text" disabled  class="form-control" name="userCode" value="${requestScope.user.userCode}" placeholder="教师账号">
                                        </div>
                                    </div>
