            ...
            <div class="container">
                ...
                <div class="row small">
                    ...
                    <form class="navbar-form center" role="search" id="searchForm">
                        ...
                        <div class="form-group " style="margin-right: 10px">
                            <select  class="form-control" name="subSelectStatus">
                                ...
                                <div class="widget-foot center">
                                    <ul class="pagination ">
                                        ...
                                        <c:if test="${page.current-1 > 0}">
                                            <li><a class="disabled" href="${ctx}/selectSubject/countSubList?page=${page.current-1}">上一页</a></li>
                                            <li><a href="${ctx}/selectSubject/countSubList?page=${page.current-1}">${page.current-1}</a></li>
                                        </c:if>

                                        <li><a href="${ctx}/selectSubject/countSubList?page=${page.current}">${page.current}</a></li>

                                        <c:if test="${page.current+1 <= page.pages}">
                                            <li><a href="${ctx}/selectSubject/countSubList?page=${page.current+1}">${page.current+1}</a></li>
                                        </c:if>
                                        <c:if test="${page.current+2 <= page.pages}">
                                            <li><a href="${ctx}/selectSubject/countSubList?page=${page.current+2}">${page.current+2}</a></li>
                                        </c:if>
                                        <c:if test="${page.current+1 <= page.pages}">
                                            <li><a href="${ctx}/selectSubject/countSubList?page=${page.current+1}">下一页</a></li>
                                        </c:if>
                                        <c:if test="${page.current+1 > page.pages}">
...
<script type="text/javascript">
    ...
    var url = "${ctx}/selectSubject/subCountListAjax";
    ...
    function pageSearch(page) {
        $.ajax({
            ...
            data:{"page":page,
                ...
                "subSelectStatus":$(" select[ name='subSelectStatus' ] ").val(),
    ...
    function exportSubjectInfo() {
        ...
        var subSelectStatus=$(" select[ name='subSelectStatus' ] ").val();
        var searchBgnTime=$(" input[ name='searchBgnTime' ] ").val();
        var searchEndTime=$(" input[ name='searchEndTime' ] ").val();


        window.location.href="${ctx}/selectSubject/export?search="+search+"&teaId="+teaId+"&forDepId="+forDepId+"&subType="+subType+"&subSelectStatus="+subSelectStatus+"&searchBgnTime="+searchBgnTime+"&searchEndTime="+searchEndTime;
    }
