                            ...
                            <div class="padd">
                                ...
                                <form class="form-horizontal" role="form" id="addForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="majName" placeholder="专业名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="majClassNum" placeholder="专业班级数">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea class="form-control" rows="4" name="majInfo" placeholder="专业介绍"></textarea>
                                        </div>
                                    </div>
